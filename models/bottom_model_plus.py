...
class BottomModelPlus(nn.Module):
    def __init__(self, dataset, size_bottom_out, num_classes, num_layer=1, activation_func_type='ReLU', use_bn=True):
        super(BottomModelPlus, self).__init__()
        self.bottom_model = BottomModel(dataset_name=dataset).get_model()
...
class BottomModelMinus(nn.Module):
    def __init__(self, dataset):
        super(BottomModelMinus, self).__init__()
        self.bottom_model = BottomModel(dataset_name=dataset).get_model()
